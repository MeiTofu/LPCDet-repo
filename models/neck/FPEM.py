...
class FPEM_FFM(nn.Module):
    def __init__(self, in_channels=None, inner_channels=128, out_channel=64, fpem_repeat=3, init_weight=True, **kwargs):
        """
        PANnet
    ...
    def forward(self, x):
        ...
        c2_ffm, c3_ffm, c4_ffm, c5_ffm = None, None, None, None
        # FPEM
