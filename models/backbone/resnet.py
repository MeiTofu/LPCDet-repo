...
_all_ = ['ResNet', 'resnet18', 'resnet34', 'resnet50', 'resnet101', 'deformable_resnet18', 'deformable_resnet50', 'resnet152']
...
class ResNet(nn.Module):
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dcn=None):
        ...
        layers = [block(self.inplanes, planes, stride=stride, downsample=downsample, dcn=dcn)]
...
def resnet50(pretrained=True, **kwargs):
    ...
    if pretrained:
        ...
        model.load_state_dict(torch.load('../lpdata/weights/resnet50-19c8e357.pth'), strict=False)
    return model
